...
\begin{itemize}
  ...
  \item El frontend no puede calcular ni ordenar el leaderboard oficial con logica propia; ese derivado pertenece al backend.
\end{itemize}
...
\begin{itemize}
  ...
  \item Los puntajes enteros pueden mostrarse sin decimales; los puntajes fraccionarios deben mostrarse con exactamente dos decimales visibles.
\end{itemize}
...
\begin{itemize}
  ...
  \item Ante correccion de resultado con cambio efectivo, deben invalidarse al menos resultado del partido, calendario afectado, score visible del usuario, leaderboard activo y detalle dependiente del cambio.
...
\begin{itemize}
  ...
  \item Ningun helper local de scoring puede usarse como fuente oficial de posicion, score visible o desempate.
\end{itemize}
