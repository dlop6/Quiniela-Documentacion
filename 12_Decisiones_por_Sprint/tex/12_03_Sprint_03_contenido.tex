...
\begin{itemize}
  ...
  \item \texttt{QH-93} conserva cinco preguntas abiertas en \texttt{signup-activation.md}: compatibilidad de rutas, contrato exacto de request/response, semantica de \texttt{GET /payments/proofs}, metadata obligatoria del comprobante y taxonomia final de errores.
