...
\texttt{payments} & comprobantes, revision y activacion administrativa & ingest de evidencia de comprobante, revision administrativa y resolucion de activacion & \texttt{users}, \texttt{audit}, \texttt{notifications} \\
...
\begin{itemize}
  ...
  \item \texttt{payments} es dueno del comprobante como evidencia funcional revisable, pero no es dueno del almacenamiento final del archivo si la captura ocurre en un proveedor externo aprobado.
  \item Un proveedor externo de formularios puede capturar archivo y metadata minima, pero no decide estado funcional, aprobacion ni rechazo; esa autoridad permanece en \texttt{payments} y \texttt{users}.
...
\begin{itemize}
  \item Si una accion administrativa impacta varios modulos, cada cambio relevante debe seguir perteneciendo a su modulo responsable y quedar auditado.
...
\begin{itemize}
  ...
  \item Ningun controller debe convertirse en responsable efectivo de reglas de dominio.
