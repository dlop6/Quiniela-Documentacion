...
\begin{enumerate}
  ...
  Documento duenio: \texttt{01\_03\_Picks\_y\_Locks}\\
  Motivo: falta definir si estas predicciones se ocultan siempre, se publican al cierre del primer partido o se revelan en otro momento controlado.

  \item \textbf{Superficies y duracion del aviso de resultado corregido}\\
  Tipo: \texttt{Decision pendiente}\\
  Criticidad: \texttt{Bloquea frontend}\\
  Documento duenio: \texttt{01\_05\_Casos\_Borde}\\
  ...
  Tipo: \texttt{Decision pendiente}\\
  Criticidad: \texttt{Bloquea frontend}\\
  Documento duenio: \texttt{01\_04\_Scoring\_y\_Desempates}\\
...
\begin{enumerate}
  ...
  Criticidad: \texttt{Bloquea frontend}\\
  Documento duenio: \texttt{01\_03\_Picks\_y\_Locks}\\
  Motivo: la separacion funcional ya esta cerrada, pero falta bajar la decision a comportamiento de interfaz y navegacion.
...
\begin{enumerate}
  ...
  Tipo: \texttt{Decision pendiente}\\
  Criticidad: \texttt{No bloqueante}\\
  Documento duenio: \texttt{01\_03\_Picks\_y\_Locks} y \texttt{05\_Datos}\\
  ...
  Tipo: \texttt{Riesgo}\\
  Criticidad: \texttt{No bloqueante}\\
  Documento duenio: \texttt{01\_01\_Reglamento\_V1}\\
...
\begin{itemize}
  ...
  \item Toda decision abierta de producto debe tener un documento duenio identificable.
