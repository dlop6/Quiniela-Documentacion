...
- Do not choose undocumented auth, session, or secret-management strategies by assumption.
...
- Do not assume a final authentication or session mechanism unless it is already documented.
